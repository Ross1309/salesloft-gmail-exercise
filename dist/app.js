...
$(document).ready(function ($) {
  ...
  new Vue({
    ...
    //  },
    computed: {
      filteredEmails: function filteredEmails() {
        var self = this;

        return this.messages.filter(function (message) {
          var parts = self.emailSearch.trim().split(" ");
          ...
          try {
            for (var _iterator = parts[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (!(searchRegex.test(message.subject) || searchRegex.test(message.sender) || searchRegex.test(message.body) || searchRegex.test(message.tags))) {
                return false;
              }
            }
          } catch (err) {
    ...
    methods: {
      ...
      tagFilter: function tagFilter(x) {
        $('.message').hide();
